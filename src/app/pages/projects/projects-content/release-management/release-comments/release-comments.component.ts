...
@Component({
  selector: 'app-release-comments',
  templateUrl: './release-comments.component.html',
  styleUrls: ['./release-comments.component.scss']
})
export class ReleaseCommentsComponent {
  ...
  getComments() {
    this.authService.getComments('release', this.releaseid).subscribe({
      next: (res: any) => {
