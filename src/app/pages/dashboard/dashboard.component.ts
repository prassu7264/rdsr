...
export class DashboardComponent {
  ...
  ngOnInit(): void {
    ...
    this.columns = [
      ...
      { title: "Gender", field: "gender", editor: "list", editorParams: { values: ['male'] } },
      { title: "Blood Group", field: "blood_group", editor: "list", editorParams: { values: ['happy'] } },
      { title: "Dept ID", field: "deptid", editor: "list", editorParams: { values: [] } },
      { title: "Position ID", field: "positionid", editor: "list", editorParams: { values: [] } },
      { title: "Shift ID", field: "shiftid", editor: "list", editorParams: { values: [] } },
      ...
      { title: "Is Active", field: "isactive", editor: "list", editorParams: { values: ['No', 'Yes'] } },
      { title: "Is Delete", field: "isdelete", editor: "list", editorParams: { values: ['No', 'Yes'] } },
      { title: "Attendance ID", field: "attendanceid", editor: "input" },
      { title: "Manager ID", field: "managerid", editor: "input" },
      { title: "Sub Manager ID", field: "sub_manager_id", editor: "input" },
      { title: "WFH", field: "wfh", editor: "list", editorParams: { values: ['No', 'Yes'] } },
      { title: "Releaving Date", field: "releaving_date", sorter: "datetime", editor: "datetime", editorParams: { min: "1900-01-01", max: "2100-12-31", format: "yyyy-MM-dd hh:mm:ss", step: 1 } },
